...
const Dashboard = ({ userData, onBirthdateChange }) => {
  ...
  return (
    <div className="container">
      {loading && <LoadingScreen message="PREPARING YOUR COSMIC JOURNEY..." />}
      {/* Hero Section */}
      ...
      <section className="section">
        <div className="content-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="card" style={{ padding: '25px' }}>
              <h3 style={{ marginBottom: '15px', textAlign: 'left' }}>ABOUT ME</h3>
              <p>Learn more about the developer behind AstroTrip and the technologies used.</p>
              <div style={{ marginTop: '20px' }}>
                <Link 
                  to="/about" 
                  className="btn"
