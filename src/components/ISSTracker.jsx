...
const ISSTracker = ({ location: userLocation }) => {
  ...
  return (
    <div className="container">
      {loading && <LoadingScreen message="ESTABLISHING CONNECTION TO ISS..." />}
      ...
      <section className="section">
        <div className="content-center">
          ...
          {/* Error messages are now displayed inline with each section */}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8" style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div className="card">
            ...
            ) : error && error.includes('ISS pass') ? (
              <div>
                <p style={{ opacity: '0.9', color: '#ffc107' }}>PREDICTION UNAVAILABLE</p>
                <p style={{ opacity: '0.7', fontSize: '14px', marginTop: '10px' }}>
                  ISS pass prediction service is temporarily unavailable.
                </p>
              </div>
            ) : (
          ...
          <div className="card">
            ...
            ) : error && error.includes('ISS position') ? (
              <div>
                <p style={{ opacity: '0.9', color: '#ffc107' }}>POSITION UNAVAILABLE</p>
                <p style={{ opacity: '0.7', fontSize: '14px', marginTop: '10px' }}>
                  ISS position data is temporarily unavailable.
                </p>
              </div>
            ) : (
              <div className="animate-pulse">
        ...
        <div style={{ maxWidth: '1200px', margin: '30px auto', textAlign: 'center' }}>
          <p style={{ opacity: '0.7', fontSize: '14px', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '30px' }}>
