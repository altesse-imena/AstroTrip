...
const PLANETS = [
  {
    ...
    image: 'https://images-assets.nasa.gov/image/PIA16853/PIA16853~thumb.jpg'
  },
  {
    id: 'venus',
    name: 'Venus',
    ...
    image: 'https://images-assets.nasa.gov/image/PIA00072/PIA00072~thumb.jpg'
  },
  {
    id: 'mars',
    name: 'Mars',
    ...
    image: 'https://images-assets.nasa.gov/image/PIA03154/PIA03154~thumb.jpg'
  },
  {
    id: 'jupiter',
    name: 'Jupiter',
    ...
    image: 'https://images-assets.nasa.gov/image/PIA00343/PIA00343~thumb.jpg'
  },
  {
    id: 'saturn',
    name: 'Saturn',
    ...
    image: 'https://images-assets.nasa.gov/image/PIA01364/PIA01364~thumb.jpg'
  },
  {
    id: 'uranus',
    name: 'Uranus',
  ...
  },
  {
    ...
    image: 'https://images-assets.nasa.gov/image/PIA01142/PIA01142~thumb.jpg'
  },
  {
    id: 'pluto',
    name: 'Pluto',
    ...
    image: 'https://images-assets.nasa.gov/image/PIA19952/PIA19952~thumb.jpg'
  }
];
...
const PlanetTrip = () => {
  ...
  return (
    <div className="container">
      {loading && <LoadingScreen message="CALCULATING INTERPLANETARY TRAJECTORY..." />}
                    ...
                    <div className="md:w-1/3 mb-4 md:mb-0 md:mr-6">
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          // Use specific fallback images for each planet
                          const fallbacks = {
                            mercury: 'https://cdn.mos.cms.futurecdn.net/GA4grWEsUYUqH58cDbRBw8.jpg',
                            venus: 'https://cdn.mos.cms.futurecdn.net/pNX8eVGowB6WT8tyrTMufk.jpg',
                            mars: 'https://cdn.mos.cms.futurecdn.net/Q4UQybPLLRQgHPVTawpiPJ.jpg',
                            jupiter: 'https://cdn.mos.cms.futurecdn.net/N8Z7SfqZCTtqSZHEDFcA3K.jpg',
                            saturn: 'https://cdn.mos.cms.futurecdn.net/PHz5Ciffm2bFtFbMmKYKBX.jpg',
                            uranus: 'https://cdn.mos.cms.futurecdn.net/uRpMCAmQo34jF8MK8zXkgQ.jpg',
                            neptune: 'https://cdn.mos.cms.futurecdn.net/eNTJrJPb2uAeK9hb9PbJsP.jpg',
                            pluto: 'https://cdn.mos.cms.futurecdn.net/DoZSMXF87kCuzbymsuEFHo.jpg'
                          };
                          e.target.src = fallbacks[selectedPlanet.id] || 'https://via.placeholder.com/300?text=Planet+Image';
                        }}
                      />
                    </div>
                    ...
                    <>
                      <div style={{ width: '120px', height: '120px', margin: '0 auto 30px', overflow: 'hidden', borderRadius: '50%', border: '2px solid rgba(255, 255, 255, 0.2)' }}>
                        <img 
                          ...
                          onError={(e) => {
                            e.target.onerror = null;
                            // Use a space-themed fallback image
                            e.target.src = 'https://images-assets.nasa.gov/image/PIA12348/PIA12348~thumb.jpg';
                          }}
                        />
                      </div>
